class Game {
	...
	unblockedPositions(piece, allowedPositions) {
	...
	getPieceAllowedMoves(pieceName) {
		...
		if (this.turn === piece.color) {
			...
			return this.unblockedPositions(piece, pieceAllowedMoves);
		} else {
			return [];
		}
	}
	...
	king_dead(color) {
		...
		for (const piece of pieces) {
			this.setClickedPiece(piece);
			const allowedMoves = this.unblockedPositions(piece, getAllowedMoves(piece));
	...
	king_checked(color) {
		...
		for (const enemyPiece of enemyPieces) {
			...
			const allowedMoves = this.unblockedPositions(enemyPiece, getAllowedMoves(enemyPiece));
